...
class DesignGenerationPipeline:
    ...
    def run_pipeline(self, keywords=None, num_designs=5, analyze_trends=True, base_keyword=None):
        ...
        Args:
            ...
            base_keyword (str, optional): Base keyword to use if provided
        ...
        if trend_report_path:
            ...
            # Generate prompts from base keyword
            optimized_prompts = self.prompt_optimizer.optimize_from_keywords([base_keyword], num_prompts=num_designs)
        else:
