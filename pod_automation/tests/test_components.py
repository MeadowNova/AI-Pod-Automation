...
class TestConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = Config(config_path=self.config_file)
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.config.config_path, self.config_file)

    def test_create_default_config(self):
        """Test creating default config."""
        # Set default values manually
        self.config.set('api.printify', '')
        self.config.set('api.etsy', '')
        self.config.set('api.openrouter', '')
        self.config.set('api.pinterest', '')
        self.config.set('data_dir', os.path.join(os.path.expanduser('~'), '.pod_automation', 'data'))
    ...
    def test_get_set_save(self):
        ...
        new_config = Config(config_path=self.config_file)
