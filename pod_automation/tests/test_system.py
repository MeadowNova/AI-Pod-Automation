...
from pod_automation.core.config import Config
...
class TestPODAutomationSystem(unittest.TestCase):
            ...
            if os.path.exists(directory):
                try:
                    ...
                    try:
                        ...
                        # If still failing, log the error but continue
                        print(f"Warning: Could not remove directory {directory}: {str(e2)}")
    ...
    def test_validate_api_connections(self):
        ...
        # In test environment, stable_diffusion might be False since we don't have real API keys
    ...
    def test_run_dashboard(self):
        ...
        # Mock dashboard
        with patch('pod_automation.dashboard.dashboard.Dashboard') as mock_dashboard:
